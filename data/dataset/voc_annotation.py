...
def convert_voc_annotation(data_path, data_type, anno_path, use_difficult_bbox=True):
    ...
    with open(anno_path, 'a') as f:
        for number, image_ind in enumerate(image_inds):
            image_path = os.path.join(data_path, 'JPEGImages', image_ind + '.jpg')
            annotation = str(number) + ' ' + image_path
            ...
            annotation += ' ' + str(width) + " " + str(height)
            for obj in objects:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", default="/home/pcl/tf_work/TF_CenterNet//VOC/")
